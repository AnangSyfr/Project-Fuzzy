<?php
 ...
 <html xmlns="http://www.w3.org/1999/xhtml">
 	<head>
		...
		<style type='text/css'>
			...
			.bg2, .bg3, .bg4 {background-color:#CCFFCC;}
			.bg5, .bg6, .bg7 {background-color:#c0c0c0;}
 ...
 <?php
 	...
 	function get_namakelompok($id_kelompok){
		$conn = $conn = mysqli_connect('localhost','root','','db_mila');
 	...
 	function derajat_keanggotaan($nilai, $bawah, $tengah, $atas){
		...
		elseif(($nilai>$tengah) && ($nilai<=$atas)) $DA=($atas-$nilai) / ($atas-$tengah);
...
<form action="" method="GET">
 ...
 <select name="bakat">
	<option value="7" <?php if(isset($_GET['bakat'])) cek_selected($_GET['bakat'],7); ?>>Bakat Tidak Berbakat</option>
...
<br />
 ...
 //tampilkan
 	if ($cc > 0) echo $row['nama']." : [".format_desimal($cc,2)."]<br />";
 } //end while
 }
